    ...
    F: {
      ...
      D: {
        I: {
          ...
          summary: "한국전쟁의 성자",
          description:
            "에밀 카폰(1916 ~ 1951)는 미 육군의 군종사제입니다. 한국전쟁 때 주한미군 군종사제로 파견되었고, 장병들의 신앙 활동을 돕고 전투가 치열하게 벌어지는 와중에 낙오된 병사를 구출하는 수훈을 세우기도 했습니다. 중공군의 참전으로 고립된 대대의 후퇴를 돕고자 하였으나, 포로로 잡혀서 수용소로 끌려갔습니다. 열악한 수용소 환경에서도 포로를 격려하다가 1951년 5월 23일 사망하였습니다. 추후 미국 명예 훈장과 태극무공훈장을 추서받습니다.",
          imageSrc: "/img/EmilJosephKapaun.png",
        },
        E: {
          name: "조르주 르메트르",
          summary: "빅뱅 이론 창시자",
          description:
            "조르주 르메트르(1894 ~ 1966)는 신앙을 지키며 학문을 통해 진리를 탐구하고, 서로 다른 학문 분야가 어떻게 대화를 해야하는지 설명한 빅뱅우주론의 창시자이자 가톨릭 사제입니다. 그는 교구 사제로서 신앙의 가치를 소중히 여겼고 마찬가지로, 과학의 발전을 소중히 여겼습니다. ",
          imageSrc: "/img/Georges.png",
        },
      },
    },
  },
